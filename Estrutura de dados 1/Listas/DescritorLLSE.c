...
int removerNoInicioDescritorLLSE(Descritor *d) {
...
int removerNoFinalDescritorLLSE(Descritor *d) {
    ...
    while (1) {
    	switch (menu(descritorUm)) {
            ...
            case 4:
                ...
                break;
            case 5:
                if (removerNoInicioDescritorLLSE(&descritorUm)) {
                ...
                break;
            case 6:
                if (removerNoFinalDescritorLLSE(&descritorUm)) {
                    printf("Valor removido");
                } else {
                    printf("Erro ao remover");
                }
